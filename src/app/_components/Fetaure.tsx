export function Feature() {
  return (
    <section id="feature" className="py-10 bg-gray-100 sm:py-16 lg:py-24">
        ...
        <div className="grid grid-cols-1 gap-6 px-4 mt-12 sm:px-0 xl:mt-20 xl:grid-cols-4 sm:grid-cols-2">
            ...
            <div className="px-5 py-6">
              ...
              <blockquote className="mt-5">
                <p className="text-base text-gray-800">
                  你让它变得如此简单。我的新网站比旧网站快得多，也更容易使用。我只需选择页面，进行更改并点击保存。
          ...
          <div className="overflow-hidden bg-white rounded-md">
            <div className="px-5 py-6">
              ...
              <blockquote className="mt-5">
                <p className="text-base text-gray-800">
                  绝对是最好的。比其他所有产品都要好。我向初学者和高级用户都推荐这个产品。
          ...
          <div className="overflow-hidden bg-white rounded-md">
            <div className="px-5 py-6">
              ...
              <blockquote className="mt-5">
                <p className="text-base text-gray-800">
                  终于，我找到了一个涵盖所有基础的模板，适合初创公司使用。我们能够在几天内上线，而不是几个月。
                  <span className="block text-sky-500">#Celebration</span>
                </p>
              </blockquote>
            </div>
          ...
          <div className="overflow-hidden bg-white rounded-md">
            <div className="px-5 py-6">
              ...
              <blockquote className="mt-5">
                <p className="text-base text-gray-800">
                  使用Celebration，与客户的沟通更快，客户能更准确地得到他们想要的东西，我完全支持这种效率。
          ...
          <div className="overflow-hidden bg-white rounded-md">
            <div className="px-5 py-6">
              ...
              <blockquote className="mt-5">
                <p className="text-base text-gray-800">
                  我的新网站比旧网站快得多，也更容易使用。我只需选择页面，进行更改并点击保存。
                  <span className="block text-sky-500">#Celebration</span>
                </p>
              </blockquote>
            </div>
