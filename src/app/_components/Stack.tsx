    ...
    <div className='flex group cursor-pointer  items-center justify-center antialiased'>
      <GlowingStarsBackgroundCard>
        ...
        <div className='flex justify-between  items-start'>
          <GlowingStarsDescription>{props.label}</GlowingStarsDescription>
          <div
            className='h-8 w-8  group-hover:scale-150   
...
export function Stack() {
  return (
    <>
      <div id='stack' className='max-w-xl mx-auto text-center '>
      ...
      <div className='grid gap-2 p-2 lg:grid-cols-3 mt-5'>
        <StackCode
          title='Next.js 15'
          label='The power of full-stack to the frontend. Read the release notes.'
        />
        <StackCode
          title='React 19'
          label='The latest version of React. Read the release notes.'
        />
        <StackCode
          title='NextAuth 5'
          label='The most advanced authentication library for Next.js. Read the release notes.'
        />
      </div>
    </>
  )
